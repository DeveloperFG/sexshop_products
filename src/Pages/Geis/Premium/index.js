...
import { geisPremiumFuncionais } from '../../Principal/items';
...
function FuncionaisPremium() {
    ...
    useEffect(() => {
        ...
        async function loadProdutos() {
            await firebase.firestore().collection('FuncionaisPremium').onSnapshot((doc) => {
                let DataUser = [];
...
export default FuncionaisPremium;